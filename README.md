...
3. Откройте терминал (командную строку): 
   · Windows: нажмите Win + R, введите cmd и нажмите Enter. Или найдите «Командная строка» в меню Пуск.(если руские слова не отображаются то ведите chcp 65001 что бы актирировать UTF-8. внимание⚠ после того если вы закроете терминал то команда слетит и вам предётся её вводить заново.)
