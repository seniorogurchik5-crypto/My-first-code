...
3. Откройте терминал (командную строку):
   · Windows: нажмите Win + R, введите cmd и нажмите Enter. Или найдите «Командная строка» в меню Пуск.(если руские слова не отображаются то ведите chcp 65001 что бы октирировать UTF-8. внимание⚠ после того если вы закроете терминал то команда слетит и вам предётся её вводить заново.)
...
4. В терминале перейдите в папку с файлом:
   cd путь/к/папке
5. Запустите программу командой:
   lua mood.lua
6. Следуйте инструкциям на экране. Программа спросит, на каком языке вы хотите общаться. Введите:
   · russkiy или english
   · Вы также можете использовать варианты с заглавными буквами, точками или восклицательными знаками — программа поймёт.
7. После выбора языка программа спросит, как у вас дела. Введите один из вариантов:
...
8. Программа ответит вам в зависимости от вашего настроения.
9. ENG:How to use the "Mood" program
